...
var EntityName, PGConnect, PassportGrantingOfficer, TYPE, addPassportGrantingOfficer, crypto, debug, deletePassportGrantingOfficerFromDatabase, deleteQuery, filter, getForEmail, getPassportGrantingOfficers, getRegionIdForPGOWithEmail, getValidationAuthorititesUnderPGOWithEmail, globals, insertPassportGrantingOfficerIntoDatabase, insertQuery, isPassportGrantingOfficer, region, removePassportGrantingOfficer, user, va,
...
addPassportGrantingOfficer = function(email, Name, client, callback) {
  ...
  return user.addUser(email, tempPassword, client, function(err) {
    return user.resetPasswordForUserWithEmail(email, client, function(err, res) {
      if (err) {
...
filter = function(req, res, next) {
  ...
  isPassportGrantingOfficer(req.session.user.email, function(err, pgoValidity) {
    if (!pgoValidity) {
      if (req.session.user) {
