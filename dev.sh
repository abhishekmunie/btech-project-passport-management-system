...
newtab -G coffee -cbw --output static/js coffeescript

newtab -G coffee -cbw --output lib src

newtab -G compass watch
#compass compile -e production --force

newtab -G jekyll build --config _config.dev.yml --watch

# newtab -G node-inspector

# newtab -G NODE_ENV='development' DEBUG='*' nodemon --watch bin/mySite --watch lib --debug-brk
# newtab -G NODE_ENV='development' DEBUG='*' nodemon --watch lib --watch config
newtab -G NODE_ENV='development' DEBUG='express:*,session,app' nodemon --watch lib --watch config
